...
| Community | Why | Touchpoint | Cost |
|---|---|---|---|
| Cosmos Hub stakers | Native airdrop cohort; already understand staking UX | Cosmos Forum technical post + Discord office hours | $0 |
...
```
Twitter / forum impression
        │
        ▼
GitHub repo star  ──────────► good-first-issue PR  ─► merged contributor
        │                                              │
        ▼                                              ▼
Eligibility checker  ─► airdrop claim  ─► first agent registered
        │                                              │
        ▼                                              ▼
Discord join                                  Reputation-NFT holder = recurring user
```

Each step is on-chain or fully measurable through free analytics
(Cloudflare + GitHub Insights). No paid attribution tooling.
