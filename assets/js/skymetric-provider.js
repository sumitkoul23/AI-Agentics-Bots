 ...
 *
 * Any web page can `<script src="/AI-Agentics-Bots/assets/js/skymetric-provider.js">` and then call:
 *
...
(() => {
  ...
  const WALLET_URL = "/AI-Agentics-Bots/wallet?dapp=" + encodeURIComponent(location.origin);
