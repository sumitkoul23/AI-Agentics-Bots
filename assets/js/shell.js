...
(() => {
  ...
  const NAV = [
    { href: "/AI-Agentics-Bots/deploy",   icon: "🚀", label: "Deploy" },
    { href: "/AI-Agentics-Bots/chains",   icon: "▦",  label: "Chains" },
    { href: "/AI-Agentics-Bots/dashboard",icon: "📊", label: "Dashboard" },
    { href: "/AI-Agentics-Bots/wallet",   icon: "👛", label: "Wallet" },
    { href: "/AI-Agentics-Bots/admin",    icon: "🛠️", label: "Admin" },
  ];
  ...
  function wireWalletButton(btn, onConnect) {
    ...
    btn.addEventListener("click", () => {
      ...
      if (a) {
        ...
        // "/AI-Agentics-Bots/wallet" is rewritten to the host base path at build time.
        const w = window.open("/AI-Agentics-Bots/wallet", "skymetric-wallet", "width=480,height=720");
